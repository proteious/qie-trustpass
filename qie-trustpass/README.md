...
QIE TrustPass is a decentralized identity and reputation platform built on the QIE Blockchain.
It enables users to create a wallet-linked digital identity and maintain an on-chain trust score that can be publicly verified without storing or exposing personal data.
...
Explorer:
https://testnet.qie.digital/address/0xCAE68262e8ed2Ade66C58e1B35feD82f65C10408
